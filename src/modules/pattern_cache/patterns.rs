...
pub fn get_raw_manual_patterns() -> Vec<ManualPatternRaw> {
    vec![
        ...
        ManualPatternRaw {
            ...
            stop_loss: None,
            take_profit: vec![230.0, 350.0],
            sell_amounts: Some(vec![40.0, 60.0]),
            token_version: Some("V2".to_string()),
        ...
        ManualPatternRaw {
            ...
            dev_cu_limit: Some("1400000".to_string()),
            mint_instructions: Some("CB:SetComputeUnitLimit>>CB:SetComputeUnitPrice>>Pumpfun:Create>>ATA:CreateIdempotent>>Pumpfun:Buy>>System:Transfer>>System:Transfer>>System:Transfer".to_string()),
            dev_buy_instruction_data: None,
